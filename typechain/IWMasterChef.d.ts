...
interface IWMasterChefInterface extends ethers.utils.Interface {
  functions: {
...
export class IWMasterChef extends Contract {
  ...
  interface: IWMasterChefInterface;
  ...
  functions: {
    ...
    sushi(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    sushi(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    sushi(overrides?: Overrides): Promise<PopulatedTransaction>;
