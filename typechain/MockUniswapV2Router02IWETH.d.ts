...
interface MockUniswapV2Router02IWETHInterface extends ethers.utils.Interface {
  functions: {
...
export class MockUniswapV2Router02IWETH extends Contract {
  ...
  interface: MockUniswapV2Router02IWETHInterface;
