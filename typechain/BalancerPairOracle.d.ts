...
interface BalancerPairOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class BalancerPairOracle extends Contract {
  ...
  interface: BalancerPairOracleInterface;
